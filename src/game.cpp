...
Game::Game(std::size_t grid_width, std::size_t grid_height) {
  ...
  gameState = new GameState(static_cast<int>(grid_width), static_cast<int>(grid_height));
  gameState->init();
  //PlaceFood();
//  std::cout << "Game Constructor: end" << std::endl;
}
...
void Game::Run(Controller const &controller, Renderer &renderer,
  ...
  while (running) {
    ...
    controller.HandleInput(running, gameState);
